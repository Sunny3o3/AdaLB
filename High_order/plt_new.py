...
SAVE_DIR = "./figures_high_order_mean"
...
# 主比较：单阶段优化器
# 建议正文主图使用 gamma=0.99 的 AdaLB，保持主设定一致
MAIN_COMPARE = [
...
HYBRID_COMPARE = [
    ...
    ("AdaLB→L-BFGS ($\\gamma=0.8$)", "adalb_lbfgs", 0.8),
]

# 输出文件名
MAIN_FIG_NAME = "high_order_main_mean_curve.png"
MAIN_ZOOM_FIG_NAME = "high_order_main_mean_curve_zoom.png"

GAMMA_FIG_NAME = "high_order_gamma_mean_curve.png"
GAMMA_ZOOM_FIG_NAME = "high_order_gamma_mean_curve_zoom.png"

HYBRID_FIG_NAME = "high_order_hybrid_mean_curve.png"
HYBRID_ZOOM_FIG_NAME = "high_order_hybrid_mean_curve_zoom.png"
...
def collect_run_files(result_dir: str, optimizer: str, gamma=None):
    ...
    for name in os.listdir(result_dir):
        ...
        if gamma_str is not None:
            ...
            # gamma=None 时，兼容如 adam_gamma0.99_seed0
...
def plot_mean_curves(
    ...
    for item in series_list:
        ...
        plt.plot(x, y, linewidth=1, label=item["label"])
...
if __name__ == "__main__":
    ...
    plot_mean_curves(
        ...
        title="High-Order ODE: mean loss curves over 5 seeds",
        xlim=None,
    ...
    plot_mean_curves(
        ...
        title="High-Order ODE: mean loss curves over 5 seeds (zoom)",
        xlim=(8000, 10000),
        ylim=(1e-5, 5e-2) if USE_LOG_SCALE else (0, 0.04),
        use_log_scale=USE_LOG_SCALE,
        show_std_band=SHOW_STD_BAND,
    )
    ...
    plot_mean_curves(
        ...
        title="High-Order ODE: sensitivity to $\\gamma$ (mean over 5 seeds)",
        xlim=None,
        ylim=None if USE_LOG_SCALE else None,
        use_log_scale=USE_LOG_SCALE,
        show_std_band=SHOW_STD_BAND,
    ...
    plot_mean_curves(
        ...
        title="High-Order ODE: sensitivity to $\\gamma$ (zoom)",
        xlim=(8000, 10000),
        ylim=(1e-6, 5e-3) if USE_LOG_SCALE else (0, 0.04),
        use_log_scale=USE_LOG_SCALE,
        show_std_band=SHOW_STD_BAND,
    )
    ...
    try:
        ...
        plot_mean_curves(
            ...
            title="High-Order ODE: L-BFGS-based pipelines (mean over 5 seeds)",
            xlim=None,
            ylim=None if USE_LOG_SCALE else None,
            use_log_scale=USE_LOG_SCALE,
            show_std_band=SHOW_STD_BAND,
        ...
        plot_mean_curves(
            ...
            title="High-Order ODE: L-BFGS-based pipelines (zoom)",
            xlim=(4500, 5500),
            ylim=(1e-8, 5e-4) if USE_LOG_SCALE else (0, 5e-4),
            use_log_scale=USE_LOG_SCALE,
            show_std_band=SHOW_STD_BAND,
        )
