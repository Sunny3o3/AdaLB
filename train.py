...
from demo1 import *
from demo1.Adambound import AdaBound
from demo1.AdaBelief import AdaBelief
from demo1.myADAM import myADAM
...
def get_ckpt_name(model='resnet', optimizer='sgd', lr=0.1, final_lr=0.1, momentum=0.9,
    ...
    name = {
        ...
        'myadam': 'lr{}-betas{}-{}-gamma{}'.format(lr, beta1, beta2,gamma),
...
def create_optimizer(args, model_params):
    if args.optim == 'sgd':
        ...
        assert args.optim == 'myadam'
        return myADAM(model_params, args.lr, betas=(args.beta1, args.beta2),
